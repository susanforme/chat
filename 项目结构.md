...
| √    | /user/:id       | get    | 请求当前页码所有用户(10条),请求id为当前页面最后一个数据的id,第一页请求为/user/1,其他分页同理 | {status:1,data:[{createTime,userName,id,password,balance}]}  |
| √    | /user/:id       | delete |                                                              |                                                              |
| √    | /commodity/:id  | get    | 请求当前页码所有商品(10条),请求id为当前页面最后一个数据的id  |                                                              |
| √    | /commodity/:id  | delete |                                                              |                                                              |
| √    | /comment/:id    | get    | 请求当前页码所有评论(10条),请求id为当前页面最后一个数据的id  | {status:1,data:{createTime,userId:{id,userName},commodityId:{createTime,name},comment}} |
| √    | /comment/:id    | delete |                                                              |                                                              |
| √    | /room/:id       | get    | 请求当前页码所有私聊房间(10条),请求id为当前页面最后一个数据的id | {status:1,data:{users:[{id,userName}],id,roomId}}            |
| √    | /room/:roomId   | delete | 请求id为roomId                                               |                                                              |
| √    | /record/:id     | get    | 请求当前页码所有聊天记录(10条),请求id为当前页面最后一个数据的id |                                                              |
| √    | /record/:id     | delete |                                                              |                                                              |
